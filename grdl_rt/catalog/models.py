...
class Artifact:
    ...
    input_type : Optional[str]
        Expected input data type (``'raster'``, ``'feature_set'``,
        ``'detection_set'``).  ``None`` means any.
    output_type : Optional[str]
        Produced output data type.  ``None`` means same as input.
    output_ports : Optional[Dict[str, str]]
        Named output ports for multi-output processors, mapping port
        name to data type.
    kwarg_inputs : Optional[Dict[str, str]]
        Named keyword-argument inputs that accept data from other steps,
        mapping kwarg name to expected data type.
    """
    ...
    def __init__(
        ...
        kwarg_inputs: dict[str, str] | None = None,
    ) -> None:
