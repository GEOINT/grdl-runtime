...
class TestRunSubcommand:
    def test_run_with_npy_input(self, tmp_path):
        ...
        with (
            patch("grdl_rt.execution.executor.resolve_processor_class") as mock_exec,
    ...
    def test_run_with_auto_tap_out(self, tmp_path):
        ...
        yaml_path = _create_workflow_yaml(
            tmp_path,
            steps=[
        ...
        with (
            patch("grdl_rt.execution.executor.resolve_processor_class", side_effect=_mock_resolve),
